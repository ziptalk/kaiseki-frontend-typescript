      ...
      <div className=" w-screen bg-[#0E0E0E] ">
        <div className="mx-auto h-full w-[500px] ">
          <div className="mx-auto h-full w-[484px] pt-[30px]">
            <div className="">
              <h1 className="text-center text-lg text-[#FAFF00] text-[24px] font-[Impact] tracking-wider drop-shadow-[1.7px_1.7px_0_rgba(250,0,0,1)] pb-[20px]">Preview</h1>
              <div className="flex h-[185px] w-full justify-between gap-[10px] border border-dashed border-[#FAFF00] p-[10px] shadow-[0_0px_20px_rgba(255,38,38,0.5)]">
                <div>
            ...
            <form onSubmit={submit}>
              <h1 className="mt-[30px] pb-[7px] text-[16px] font-normal text-white">name</h1>
              <input
                name="name"
                type="text"
                placeholder="name"
              ...
              />
              <h1 className="mt-[15px] pb-[7px] text-[16px] font-normal text-white">ticker</h1>
              <input
                name="ticker"
                type="text"
                placeholder="ticker"
                ...
                className="h-[50px] w-full rounded-[5px] border border-[#8F8F8F] bg-[#303030] p-[10px] text-white"
              />
              <h1 className="mt-[15px] pb-[7px] text-[16px] font-normal text-white">image</h1>
              <input
                name="image"
                type="file"
                accept="image/*"
                className=" flex h-[50px] items-center w-full rounded-[5px] border border-[#8F8F8F] bg-[#303030] p-[15px] text-white"
              />
              ...
              <button
                type="submit"
                className="mt-[34px] h-[60px] w-full rounded-[8px] bg-gradient-to-b from-[#FF0000] to-[#900000] shadow-[0_0px_20px_rgba(255,38,38,0.5)] text-white text-[16px] font-light font-['Impact'] tracking-wider"
              >
                Create Token
              </button>
            </form>
