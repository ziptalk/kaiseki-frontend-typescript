            ...
            .then((e) => {
              ...
              if (void 0 !== e.s) r("unknown_symbol");
                ...
                a({
                  ...
                  unit_id:
                    null !== (n = e.unit_id) && void 0 !== n ? n : e["unit-id"],
                  original_unit_id:
                  ...
                  minmov:
                    null !==
                      (m =
                        null !== (_ = e.minmovement) && void 0 !== _
                          ? _
                          : e.minmov) && void 0 !== m
                      ? m
                      : 0,
                  minmove2:
                    null !== (p = e.minmovement2) && void 0 !== p
                      ? p
                      : e.minmove2,
                  session:
                    null !== (b = e.session) && void 0 !== b
                      ? b
                      : e["session-regular"],
                  session_holidays:
                  ...
                  supported_resolutions:
                    null !==
                      (v =
                        null !==
                          (f =
                            null !== (g = e.supported_resolutions) &&
                            void 0 !== g
                              ? g
      ...
      if (void 0 !== t) {
        ...
        0 !== e.length && (s += "?"),
          (s += e
            .map(
              (e) =>
                `${encodeURIComponent(e)}=${encodeURIComponent(t[e].toString())}`,
            )
            .join("&"));
      }
